---
title: "bulk-triage"
description: "Parallel CWSS scoring across many vulnerabilities — each analysed independently, single consolidated `.vulnetix/memory.yaml` write at the end, output grouped by P1–P4 priority tiers."
weight: 1
---
