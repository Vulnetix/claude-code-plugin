---
title: "sbom-generate"
description: "Generate CycloneDX 1.7 and/or SPDX 2.3 SBOMs for the repo, optionally cosign-signed, optionally cross-validated against syft output."
weight: 13
---

<!-- GENERATED by scripts/gen-docs.mjs. Do not edit; change the source and regenerate. -->

**Arguments:** `[--format cyclonedx|spdx|both] [--sign] [--output PATH]`

**Grants:** `Bash(vulnetix:*) Read Grep Glob Write Bash(syft:*) Bash(cosign:*)`

**Typically followed by:** `vex-publish`
