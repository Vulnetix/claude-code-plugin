...
description: "IDS/IPS detection content for a CVE — Snort/Suricata-compatible rules, YARA signatures, ProjectDiscovery Nuclei templates, traffic-filter rules."
weight: 5
---
...
**Grants:** `Bash(vulnetix:*) Read Grep Glob Write`

**Typically followed by:** `exploit-test`, `verify-fix`
