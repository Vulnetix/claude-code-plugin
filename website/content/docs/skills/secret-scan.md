---
title: "secret-scan"
description: "Hardcoded-secret detection — AWS keys, GitHub PATs, Slack tokens, Stripe keys, generic high-entropy strings."
weight: 14
---

<!-- GENERATED by scripts/gen-docs.mjs. Do not edit; change the source and regenerate. -->

**Arguments:** `[--paths file1 file2] [--staged-only]`
