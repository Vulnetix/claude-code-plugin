...
description: "Dockerfile / Containerfile / compose analysis plus optional Trivy / Grype / Syft composition when those binaries are present."
weight: 1
---

<!-- GENERATED by scripts/gen-docs.mjs. Do not edit; change the source and regenerate. -->

**Arguments:** `[--paths Dockerfile1 Dockerfile2] [--image registry/img:tag]`

**Grants:** `Bash(vulnetix:*) Read Grep Glob Bash(syft:*) Bash(grype:*) Bash(trivy:*)`
