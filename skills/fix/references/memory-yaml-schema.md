...
vulnerabilities:
  CVE-2021-44228:                       # Primary vuln ID (key)
    ...
    threat_model:                        # Populated by vulnetix vdb exploits
    ...
    cwss:                                # CWSS-derived priority (populated by vulnetix vdb exploits)
    ...
    pocs:                                # PoC sources (from vulnetix vdb exploits, never executed)
    ...
    history:                             # Append-only event log
      - date: "2024-01-15T10:30:00Z"
        event: discovered
        detail: "Found via fix CVE-2021-44228"
      - date: "2024-01-15T11:00:00Z"
        event: fix-applied
