...
4. If a prior entry exists:
   ...
   - If `cwss` data exists from a prior `vulnetix vdb exploits` analysis, display: `Priority: <P1/P2/P3/P4> (<score>) — "<priority description>"` and use the threat model context to inform fix urgency.
